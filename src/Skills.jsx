    ...
    <div className="flex flex-col justify-around gap-8 p-8 align-middle text">
      ...
      <div className="flex flex-col gap-4 items-left">
        ...
        <div className="flex flex-wrap max-w-lg gap-2">
          ...
          <img
            src="https://img.shields.io/badge/gatsby-%23663399.svg?logo=gatsby&logoColor=white&style=for-the-badge"
            alt="Gatsby"
          />
          <img
          ...
          />
          <img
            src="https://img.shields.io/badge/bootstrap-%237952b3.svg?logo=bootstrap&logoColor=white&style=for-the-badge"
            alt="Bootstrap"
          />
        </div>
      </div>
